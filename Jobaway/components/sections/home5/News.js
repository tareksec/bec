                                ...
                                <div className="inner-box">
                                    ...
                                    <div className="lower-content">
                                        ...
                                        <ul className="post-info">
                                            <li><i className="icon-37"></i>March 20, 2023</li>
                                            <li><i className="icon-38"></i><Link href="/blog-details">Ralph Edwards</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="news-block-three wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div className="inner-box">
                                    ...
                                    <div className="lower-content">
                                        ...
                                        <ul className="post-info">
                                            <li><i className="icon-37"></i>March 19, 2023</li>
                                            <li><i className="icon-38"></i><Link href="/blog-details">Theresa Webb</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="news-block-three wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div className="inner-box">
                                    ...
                                    <div className="lower-content">
                                        ...
                                        <ul className="post-info">
                                            <li><i className="icon-37"></i>March 18, 2023</li>
                                            <li><i className="icon-38"></i><Link href="/blog-details">Arlene McCoy</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
