          ...
          <div className="row clearfix">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 footer-column">
              <div className="footer-widget logo-widget mr_30">
                ...
                <p>
                  A premier professional ecosystem dedicated to empowering careers and strengthening corporate brands through strategic consulting, talent solutions, and dynamic networking.
                </p>
                <div className="bec-badge-pill">
                  <span>✨</span>
                  <span>Empowering Bangladesh's Future Leaders</span>
                </div>
              </div>
            </div>
              ...
              <div className="footer-widget links-widget">
                ...
                <div className="widget-content">
                  <ul className="links-list">
                    ...
                    <li><Link href="/service-details-3">Business Consulting</Link></li>
                    <li><Link href="/service-details-2">Training & Workshops</Link></li>
              ...
              <div className="footer-widget links-widget">
                ...
                <div className="widget-content">
                  <ul className="links-list">
                    ...
                    <li><Link href="/testimonial">Reviews & Impact</Link></li>
              ...
              <div className="footer-widget">
                ...
                <div className="widget-content">
                  <p className="bec-newsletter-desc">
                    Subscribe to receive strategic industry reports, exclusive event invitations, and executive leadership briefings.
                  </p>
                  ...
                  {!subscribed ? (
                    ...
                    <div className="bec-newsletter-success">
                      ✓ Subscribed! Welcome to the BEC Executive Briefing network.
                    </div>
                  )}
