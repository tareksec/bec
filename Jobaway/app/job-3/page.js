...
export default function Job_Page_Three() {
            ...
            <section className="job-section pt_110 pb_90">
                <div className="auto-container">
                    <div className="sec-title centred pb_60 sec-title-animation animation-style2">
                        <span className="sub-title mb_10 title-animation">Post ed jobs</span>
                        ...
                        <div className="job-block-one">
                            <div className="upper-box">
                                <ul className="job-info">
                                    <li><i className="icon-43"></i>Posted by <span>6 months ago</span></li>
                            ...
                            <div className="inner-box">
                                ...
                                <div className="btn-box">
                                    <Link href="/job-details" className="theme-btn btn-one">View Details</Link>
                                </div>
                            </div>
                        </div>
                        <div className="job-block-one">
