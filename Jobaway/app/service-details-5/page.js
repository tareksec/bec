...
export default function Service_Details_Five() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={3} footerStyle={2} breadcrumbTitle="Workforce System">
                            ...
                            <div className="service-sidebar mr_40">
                                <div className="category-widget mb_40">
                                    <ul className="category-list clearfix">
                                        ...
                                        <li><Link href="/service-details-5" className='current'>Workforce System <i className="icon-42"></i></Link></li>
                                        <li><Link href="/service-details-6">Temporary Jobs <i className="icon-42"></i></Link></li>
                                    </ul>
                                </div>
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                            <div className="service-details-content">
                                <div className="sec-title mb_70">
                                    ...
                                    <h2>The Workforce System Process for Optimal Results</h2>
                                ...
                                <figure className="image-box mb_30"><img src="assets/images/service/service-12.jpg" alt=""/></figure>
