...
export default function Service_Details_Four() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={3} footerStyle={2} breadcrumbTitle="Payroll Services">
                            ...
                            <div className="service-sidebar mr_40">
                                <div className="category-widget mb_40">
                                    <ul className="category-list clearfix">
                                        ...
                                        <li><Link href="/service-details-4" className='current'>Payroll Services <i className="icon-42"></i></Link></li>
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                            <div className="service-details-content">
                                <div className="sec-title mb_70">
                                    ...
                                    <h2>The Payroll Services Process for Optimal Results</h2>
