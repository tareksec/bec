...
export default function Service_Details() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={3} footerStyle={2} breadcrumbTitle="Executive Search">
                            ...
                            <div className="service-sidebar mr_40">
                                <div className="category-widget mb_40">
                                    <ul className="category-list clearfix">
                                        <li><Link href="/service-details" className="current">Executive Search <i className="icon-42"></i></Link></li>
